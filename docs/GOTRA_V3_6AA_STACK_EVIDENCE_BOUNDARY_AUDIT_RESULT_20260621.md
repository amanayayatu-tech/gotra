...
uv run python scripts/baseline_v3_6aa_stack_evidence_boundary_audit.py \
  --audit-run-id baseline_v3_6aa_stack_evidence_boundary_audit_fixture_20260621T060511Z \
  --snapshot /tmp/gotra_v3_6aa_stack_audit_fixture_20260621T060511Z/stack_snapshot.json \
  --output-dir /tmp/gotra_v3_6aa_stack_audit_fixture_20260621T060511Z/runs
```

Output, not committed:

`/tmp/gotra_v3_6aa_stack_audit_fixture_20260621T060511Z/runs/baseline_v3_6aa_stack_evidence_boundary_audit_fixture_20260621T060511Z/summary.json`

Summary sha256:

`7e7b7e34dd87c8d3f999d4e2d6f91014aca1e37474d927445514018072561f72`
...
uv run pytest -q tests/test_evidence_package_dashboard.py tests/test_short_horizon_first_capture.py tests/test_short_horizon_outcome_recheck.py tests/test_forward_live_maturity_monitor.py
uv run pytest -q
git diff --check
```
...
- v3.6X/v3.6Y/v3.6Z/v3.6S regression tests: `46 passed`
